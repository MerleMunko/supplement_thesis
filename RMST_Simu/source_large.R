...
n_vec_list       <- list(balanced_10    = 10*c(15,15,15,15),
                         unbalanced_10  = 10*c(10,20,10,20),
                         balanced_8     = 8*c(15,15,15,15),
                         unbalanced_8   = 8*c(10,20,10,20),
                         balanced_6     = 6*c(15,15,15,15),
                         unbalanced_6   = 6*c(10,20,10,20))
...
for(set.ind in 1:nrow(Settings)){
  ...
  # censoring rates
  save(censp_s, file = paste(path,"/results_large/censrate/cens_",set_names[set.ind],".Rdata", sep=""))
  # results for the global error rates
  save(results, file = paste(path, "/results_large/errorrate/",set_names[set.ind],".Rdata", sep=""))
  # results for the local error rates
  save(results_multiple, file = paste(path, "/results_large/multiple_errorrate/multiple_",set_names[set.ind],".Rdata", sep=""))
  # decision list for all decisions
  save(decision_arr, file = paste(path, "/results_large/decision_list/decision_",set_names[set.ind],".Rdata", sep=""))
